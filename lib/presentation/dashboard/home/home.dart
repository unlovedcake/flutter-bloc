              ...
              children: [
                ...
                BlocConsumer<ProductBloc, ProductState>(
                  builder: (context, state) {
                    if (state is ProductsFavoriteLoaded) {
                      favoriteDocumentIds = state.documentIdFavorites!;
                    }
                    ...
                    if (state is ProductsLoading) {
                      ...
                      double totalGridViewHeight =
                          187 * numberOfRows.toDouble();
                ...
                Container(
                    height: 300, color: Colors.blue, child: Text('Fotter'))
              ],
            ),
          ),
        ));
